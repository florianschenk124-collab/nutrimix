...
<span style={{flex:1,fontSize:12}}>{sd(s.name,s.formula)}</span>
...
<tbody>{[...res.tank_a,...res.tank_b].filter(s=>s.g_total>0).map(s=>(<tr key={s.salt_formula}><td style={{fontSize:12}}>{sd(s.salt_name,s.salt_formula)}</td>
